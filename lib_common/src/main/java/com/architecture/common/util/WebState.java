...
/**
 * Created by xuying on 2018/5/16.
 */
...
public class WebState {
    ...
    public static final boolean isWeb(Context context) {
        if (getNetWorkStates(context) == TYPE_NONE) {
            return false;
        } else {
            return true;
        }
    ...
    public static final boolean isWIFI(Context context) {
        if (getNetWorkStates(context) == TYPE_WIFI) {
            return true;
        } else {
            return false;
        }
